...
import { ChartModule, Tooltip, Legend, Highlight } from '@syncfusion/ej2-angular-charts';
import { Browser } from '@syncfusion/ej2-base';
import { HeaderComponent } from '../../../shared/components/header/header.component';
import { lineCustomSeries, LinePrimaryXAxis, LinePrimaryYAxis } from '../../../../../public/data';
import {
  LineSeriesService,
  DateTimeService,
  LegendService,
...
import {
  CategoryService, StepLineSeriesService, SplineSeriesService, StackingLineSeriesService,
...
@Component({
  ...
  providers: [CategoryService, LineSeriesService, StepLineSeriesService, SplineSeriesService, StackingLineSeriesService, DateTimeService,
    SplineAreaSeriesService, MultiColoredLineSeriesService, ParetoSeriesService, ColumnSeriesService, LegendService,
    TooltipService,
    DataLabelService,
    StackingLineSeries,],
